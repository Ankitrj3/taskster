  ...
  return (
    <section className="py-24 bg-zinc-50 dark:bg-zinc-900 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mb-12">
          <div className="h-8 w-64 bg-zinc-200 dark:bg-zinc-800 rounded mb-4 animate-pulse mx-auto" />
          <div className="h-5 w-96 bg-zinc-200 dark:bg-zinc-800 rounded animate-pulse mx-auto" />
        </div>
        ...
        <div className="h-12 w-48 bg-zinc-200 dark:bg-zinc-800 rounded mx-auto animate-pulse" />
      </div>
    </section>
  );
}
